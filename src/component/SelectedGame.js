...
const SelectedGame = (props) => {
    ...
    return (
        <ThemeContext.Consumer>
            {({theme}) => (
                <div style={{backgroundColor: theme.divBackground, color: theme.divColor}}
                     className="card my-2 mx-2 mt-5">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-text">
                            ...
                            <div className="stars-inner" style={{width: selectedGame.rate * 14.75}}/>
                        </div><br/>
